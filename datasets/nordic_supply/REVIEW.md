...
| 60 | open | `row:claims.CL-2025-00001.description` | personal data in free text (45 rows in this column); confirm it is intended | 1 x Älv Summit Tarp Petrol on pallet 1 arrived with crushed cartons and torn packaging. Also affected: Skjærgård Palsa Hiking Shorts L Fores |
| 60 | open | `row:claims.CL-2025-00036.description` | personal data in free text (45 rows in this column); confirm it is intended | 1 x Vuoma Storm II Synthetic Sleeping Bag -20°C Forest on pallet 1 arrived with crushed cartons and torn packaging. Driver noted the damage  |
| 60 | open | `row:claims.CL-2025-00048.description` | personal data in free text (45 rows in this column); confirm it is intended | Delivery promised 2025-09-01 arrived 2025-09-03 (2 days late). Second late delivery this quarter, customer escalates. Call back Ebba on +46  |
| 60 | open | `row:orders.SO-2025-000007.notes` | personal data in free text (748 rows in this column); confirm it is intended | Noora asked for delivery after 10:00, mobile +358 40 587 2869 |
| 60 | open | `row:orders.SO-2025-000066.notes` | personal data in free text (748 rows in this column); confirm it is intended | Call Elin Karlsson on +46 70 239 33 06 30 min before delivery |
| 60 | open | `row:orders.SO-2025-000083.notes` | personal data in free text (748 rows in this column); confirm it is intended | Nils asked for delivery after 10:00, mobile +46 70 435 42 79 |
| 50 | open | `template:claim_lines.issue_note:b7ba0f45` | template text repeated 77 times; one bad sentence repeats 77 times | Torn outer wrap |
| 50 | open | `template:claim_lines.issue_note:bb210253` | template text repeated 81 times; one bad sentence repeats 81 times | Product surface scratched |
| 50 | open | `template:claim_lines.issue_note:f757888b` | template text repeated 77 times; one bad sentence repeats 77 times | Carton missing |
| 50 | open | `template:claims.resolution_note:13b1d8e5` | template text repeated 110 times; one bad sentence repeats 110 times | Credit note issued. |
| 50 | open | `template:claims.resolution_note:1a6ae744` | template text repeated 114 times; one bad sentence repeats 114 times | Redelivery completed, customer confirmed. |
| 50 | open | `template:claims.resolution_note:3d2a23ba` | template text repeated 130 times; one bad sentence repeats 130 times | Goodwill credit agreed with account manager. |
| 50 | open | `template:orders.notes:4a810b3a` | template text repeated 1444 times; one bad sentence repeats 1444 times | Deliver before store opening |
| 50 | open | `template:orders.notes:b7f8ca4a` | template text repeated 1505 times; one bad sentence repeats 1505 times | Part of annual pre-order |
| 50 | open | `template:orders.notes:deb031d3` | template text repeated 1505 times; one bad sentence repeats 1505 times | Season opener stock |
| 40 | open | `row:claim_lines.205.amount` | outlier: 16128.00 vs median 168.80 | 16128.0 |
| 40 | open | `row:claim_lines.810.amount` | outlier: 17275.20 vs median 168.80 | 17275.2 |
| 40 | open | `row:claim_lines.900.amount` | outlier: 17275.20 vs median 168.80 | 17275.2 |
| 40 | open | `row:claims.CL-2025-00202.claimed_amount` | outlier: 16342.00 vs median 319.78 | 16342.0 |
| 40 | open | `row:claims.CL-2025-00213.approved_amount` | outlier: 12772.50 vs median 172.32 | 12772.5 |
| 40 | open | `row:claims.CL-2025-00305.approved_amount` | outlier: 10857.11 vs median 172.32 | 10857.11 |
| 40 | open | `row:claims.CL-2026-00411.approved_amount` | outlier: 17275.20 vs median 172.32 | 17275.2 |
| 40 | open | `row:claims.CL-2026-00411.claimed_amount` | outlier: 17275.20 vs median 319.78 | 17275.2 |
| 40 | open | `row:claims.CL-2026-00496.claimed_amount` | outlier: 17925.16 vs median 319.78 | 17925.16 |
| 40 | open | `row:order_lines.16318.line_total` | outlier: 70269.60 vs median 433.20 | 70269.6 |
| 40 | open | `row:order_lines.17837.list_price` | outlier: 1134.00 vs median 61.00 | 1134.0 |
| 40 | open | `row:order_lines.17837.unit_price` | outlier: 1134.00 vs median 61.00 | 1134.0 |
| 40 | open | `row:order_lines.23517.list_price` | outlier: 1134.00 vs median 61.00 | 1134.0 |
| 40 | open | `row:order_lines.23517.unit_price` | outlier: 1134.00 vs median 61.00 | 1134.0 |
| 40 | open | `row:order_lines.26392.line_total` | outlier: 71748.96 vs median 433.20 | 71748.96 |
| 40 | open | `row:order_lines.5537.line_total` | outlier: 70580.16 vs median 433.20 | 70580.16 |
| 40 | open | `row:order_lines.6297.list_price` | outlier: 1134.00 vs median 61.00 | 1134.0 |
| 40 | open | `row:order_lines.6297.unit_price` | outlier: 1134.00 vs median 61.00 | 1134.0 |
| 40 | open | `row:orders.SO-2025-001983.total_net` | outlier: 79757.87 vs median 3297.11 | 79757.87 |
| 40 | open | `row:orders.SO-2025-003983.total_net` | outlier: 80467.66 vs median 3297.11 | 80467.66 |
| 40 | open | `row:orders.SO-2026-006048.total_net` | outlier: 87697.62 vs median 3297.11 | 87697.62 |
...
| 40 | open | `row:shipments.SH-2026-000595.weight_kg` | outlier: 1062.50 vs median 21.20 | 1062.5 |
| 40 | open | `row:shipments.SH-2026-002066.weight_kg` | outlier: 916.10 vs median 21.20 | 916.1 |
| 40 | open | `row:shipments.SH-2026-006463.weight_kg` | outlier: 1054.00 vs median 21.20 | 1054.0 |
